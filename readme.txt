...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\urledit on
     Windows, /home/user/dev/urledit on Linux) in a file named
     urledit@jordan.sissel and copy that file to
